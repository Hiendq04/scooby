        ...
        <div class="container-xxl">
            ...
            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                ...
                <div class="dropdown zindex-popover">
                    <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
                        <img src="{{ asset('assets/images/flag/GB.png') }}" alt="">
                    </a>
                    <div
                        ...
                        <div class="card border-0">
                            <ul class="list-unstyled py-2 px-3">
                                <li>
                                    <a href="#" class=""><img src="{{ asset('assets/images/flag/GB.png') }}"
                                            alt="">
                                        English</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{ asset('assets/images/flag/DE.png') }}"
                                            alt="">
                                        German</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{ asset('assets/images/flag/FR.png') }}"
                                            alt="">
                                        French</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{ asset('assets/images/flag/IT.png') }}"
                                            alt="">
                                        Italian</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{ asset('assets/images/flag/RU.png') }}"
                                            alt="">
                                        Russian</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active">
                                    <ul class="list-unstyled list mb-0">
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle"
                                                    src="{{ asset('assets/images/xs/avatar3.svg') }}" alt="">
                                                <div class="flex-fill ms-2">
                                                    <p class="d-flex justify-content-between mb-0 "><span
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle"
                                                    src="{{ asset('assets/images/xs/avatar5.svg') }}" alt="">
                                                <div class="flex-fill ms-2">
                                                    <p class="d-flex justify-content-between mb-0 "><span
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle"
                                                    src="{{ asset('assets/images/xs/avatar6.svg') }}" alt="">
                                                <div class="flex-fill ms-2">
                                                    <p class="d-flex justify-content-between mb-0 "><span
                                        ...
                                        <li class="py-2">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle"
                                                    src="{{ asset('assets/images/xs/avatar7.svg') }}" alt="">
                                                <div class="flex-fill ms-2">
                                                    <p class="d-flex justify-content-between mb-0 "><span
                    ...
                    <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                        <div class="card border-0 w280">
                            ...
                            <div class="list-group m-2 ">
                                ...
                                <a href="{{route('/')}}"
                                    class="list-group-item list-group-item-action border-0 "><i
                                        class="icofont-home fs-5 me-3"></i>Client Page</a>
                                <a href="{{route('logout')}}"
                                    class="list-group-item list-group-item-action border-0 "><i
            ...
            <div class="order-0 col-lg-4 col-md-4 col-sm-12 col-12 mb-3 mb-md-0 ">
                <div class="input-group flex-nowrap input-group-lg">
                    <input disabled type="search" class="form-control" placeholder="Search" aria-label="search"
