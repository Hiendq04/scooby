                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div
                                ...
                                <h3 class="fw-bold mb-0">Products Update</h3>
                                <button type="submit"
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input value="{{ $product->price_sale ?? 0 }}" name="price_sale"
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-12">
                                                <label class="form-label">Product Price</label>
                                                <input value="{{ $product->quantity ?? 0 }}" name="quantity" type="number"
                                                    class="form-control">
                                                @error('quantity')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-check">
                                            <input name="status" value="published" class="form-check-input" type="radio"
                                                name="couponsstatus" {{ $product->status == 'published' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input name="status" value="hidden" class="form-check-input" type="radio"
                                                name="couponsstatus" {{ $product->status == 'hidden' ? 'checked' : '' }}>
                                            <label class="form-check-label">
                                                Hidden
                                            </label>
                                        </div>
