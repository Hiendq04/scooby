                ...
                <div class="col-lg-7">
                    <div class="tab-content tab-content1" id="v-pills-tabContent">
                        <div class="tab-pane fade active show" id="v-pills-img1" role="tabpanel"
                            ...
                            <img class="img-fluid"
                                src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-big-01.png" alt>
                        </div>
                        <div class="tab-pane fade" id="v-pills-img2" role="tabpanel" aria-labelledby="v-pills-img2-tab">
                            <img class="img-fluid"
                                src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-big-02.png" alt>
                        </div>
                        <div class="tab-pane fade" id="v-pills-img3" role="tabpanel" aria-labelledby="v-pills-img3-tab">
                            <img class="img-fluid"
                                src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-big-03.png" alt>
                        </div>
                        <div class="tab-pane fade" id="v-pills-img4" role="tabpanel" aria-labelledby="v-pills-img4-tab">
                            <img class="img-fluid"
                                src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-big-04.png" alt>
                        </div>
                        <div class="tab-pane fade" id="v-pills-img5" role="tabpanel" aria-labelledby="v-pills-img5-tab">
                            <img class="img-fluid"
                                src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-big-05.png" alt>
                        </div>
                    </div>
                    <div class="nav nav1 nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link active" id="v-pills-img1-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="true">
                            <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-sm-01.png" alt>
                        </button>
                        <button class="nav-link" id="v-pills-img2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img2"
                            ...
                            <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-sm-02.png" alt>
                        </button>
                        <button class="nav-link" id="v-pills-img3-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img3"
                            ...
                            <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-sm-03.png" alt>
                        </button>
                        <button class="nav-link" id="v-pills-img4-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img4"
                            ...
                            <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-sm-04.png" alt>
                        </button>
                        <button class="nav-link" id="v-pills-img5-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img5"
                            ...
                            <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/shop-sm-05.png" alt>
                        </button>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="shop-details-content">
                        ...
                        <p>Donec bibendum enim ut elit porta ullamcorper. Vestibulum Nai wekemdini iaculis vitae nulla.
                            Morbi mattis nec mi ac mollis. </p>
                        <div class="shop-quantity d-flex align-items-center justify-content-start mb-20">
                            ...
                            <a href="https://demo.egenslab.com/html/scooby/preview/cart.html" class="primary-btn3">Add to
                                cart</a>
                        </div>
                        <div class="buy-now-btn">
                            <a href="https://demo.egenslab.com/html/scooby/preview/cart.html">Buy Now</a>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="nav nav2 nav  nav-pills" id="v-pills-tab2" role="tablist" aria-orientation="vertical">
                        ...
                        <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="v-pills-profile" aria-selected="true">Excessive Info</button>
                    ...
                    <div class="tab-content tab-content2" id="v-pills-tabContent2">
                        <div class="tab-pane fade active show" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="description">
                                <p class="para-2 mb-3">This is a type of food that is specifically formulated and intended
                                    for consumption by pets. It is usually sold in the form of dry kibble or wet cans, and
                                    is designed to meet the nutritional needs of a variety of different types of pets,
                                    including dogs, cats, and small animals like guinea pigs and rabbits.</p>
                                <p class="para-2 mb-3">This food may help from a variety of different ingredients,
                                    including meat, grains, vegetables, and fortified vitamins and minerals. Some pet food
                                    is formulated for specific life stages, such as puppy or senior, and may contain higher
                                    levels of certain nutrients to support the needs of pets at those stages of life.</p>
                                <p class="para-2 mb-0">At the end, also formulated for pets with special dietary needs,
                                    such as those with food allergies or sensitivities.</p>
                            </div>
                        </div>
                            ...
                            <div class="addithonal-information">
                                <table class="table total-table2">
                                    <tbody>
                                        <tr>
                                            <td>Protein</td>
                                            <td>25%, to build and repair tissues, produce enzymes, and maintain healthy
                                                organs.</td>
                                        </tr>
                                        <tr>
                                            <td>Fats</td>
                                        ...
                                        <tr>
                                            <td>Carbohydrates</td>
                                            <td>10%, provide energy and help pets maintain healthy weight and keep good the
                                                digestive system.</td>
                                        </tr>
                                        <tr>
                                            <td>Minerals</td>
                                            <td>20%,Help building strong bones, maintaining healthy muscles, and regulating
                                                the body's fluid balance.</td>
                                        </tr>
                                        <tr>
                                            <td>Vitamins</td>
                                            <td>15.5%, Essential for a variety of functions in the body, including the
                                                immune system, metabolism, and growth.</td>
                                        </tr>
                                        <tr>
                                            <td>Animale</td>
                                            <td> For Dog, Cat.</td>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="collection-card">
                                ...
                                <div class="collection-img">
                                    ...
                                    <div class="view-dt-btn">
                                        ...
                                        <a href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">View
                                            Details</a>
                                    </div>
                                ...
                                <div class="collection-content text-center">
                                    <h4><a href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Whiskas
                        ...
                        <div class="swiper-slide">
                            <div class="collection-card">
                                ...
                                <div class="collection-content text-center">
                                    <h4><a href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Friskies
                        ...
                        <div class="swiper-slide">
                            <div class="collection-card">
                                ...
                                <div class="collection-content text-center">
                                    <h4><a href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Joules
                        ...
                        <div class="swiper-slide">
                            <div class="collection-card">
                                ...
                                <div class="collection-content text-center">
                                    <h4><a href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Natural
                                            Dog Fresh Food.</a></h4>
                                    <div class="price">
                                        <h6>$18.00</h6>
                                        <del>$30.00</del>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-card">
                                ...
                                <div class="collection-content text-center">
                                    <h4><a href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Rooibos
