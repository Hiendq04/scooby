                        ...
                        <table class="eg-table table cart-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-label="Image">
                                        <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/cart-01.png"
                                            alt>
                                    </td>
                                    <td data-label="Food Name"><a
                                            href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Whiskas
                                            Cat Food Core Tuna</a></td>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Image">
                                        <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/cart-02.png"
                                            alt>
                                    </td>
                                    <td data-label="Food Name"><a
                                            href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Friskies
                                            Kitten Discoveries.</a></td>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Image">
                                        <img src="https://demo.egenslab.com/html/scooby/preview/assets/images/bg/cart-03.png"
                                            alt>
                                    </td>
                                    <td data-label="Food Name"><a
                                            href="https://demo.egenslab.com/html/scooby/preview/shop-details.html">Natural
                                            Dog Fresh Food.</a></td>
                ...
                <div class="col-lg-8">
                    ...
                    <ul class="cart-btn-group">
                        <li><a href="{{route('shop')}}"
                                class="primary-btn2 btn-lg">Continue to shopping</a></li>
                        <li><a href="{{route('checkout')}}"
                                class="primary-btn3 btn-lg">Proceed to Checkout</a></li>
                    </ul>
                </div>
            </div>
        </div>
